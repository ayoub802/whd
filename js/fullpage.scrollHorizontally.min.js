...
/* eslint-disable */ window.fp_scrollHorizontallyExtension = function () {
  var e = this,
    ...
    p = ".fp-section",
    u = ".fp-slide";
  (e.getScrollSection = function (e) {
    var t,
      i = e.type,
      n = e.scrollSection,
      o = d(".fp-section.active")[0],
      l = d(u, o).length,
      r = f.scrollHorizontally && 1 < l,
      c = 1 === d(p).length;
    if (r)
      if (((t = d(".fp-slide.active", o)[0]), "down" === i)) {
        if (s.index(t) + 1 !== l || c) return a.moveSlideRight;
      } else if (s.index(t) || c) return a.moveSlideLeft;
    return n;
  }),
    (e.c = n.c);
...
var _0x44ed = [
  ...
  "addEventListener",
  "load",
  "fp_scrollHorizontallyExtension",
  "options",
  "fp-section",
  ".fp-slide",
  "fp-fixed",
...
window[_0x4132("0x0")] = function () {
  ...
  function _0x250fad() {
    return (
      parseInt(_0xfdf934("#" + _0x2baee7)[0x0][_0x4132("0x5")]) ===
      _0x2baee7[_0x4132("0x6")] + 0x1
    );
  }
  (_0x2a1a7e[_0x2a0e98] = function () {
    return (
      _0xfdf934(_0x343372[0x0][_0x4132("0x7")]())["length"] ==
        _0x506eda[_0x4132("0x6")] + _0x2baee7[_0x4132("0x6")] + 0x1 &&
      _0x250fad()
    );
  }),
    (_0x2a1a7e[_0x4132("0x8")] = function (_0x711793, _0x139f25) {
      var _0x620ee9,
        _0x3c6c46 = _0xfdf934(_0x5077f3)[0x0],
        _0x190faa = _0xfdf934(_0x5d90b3, _0x3c6c46)["length"];
      if (_0x3d5629[_0x4132("0x9")] && _0x190faa > 0x1) {
        if (!_0x2a1a7e[_0x2a0e98]()) return;
        if (
          ((_0x620ee9 = _0xfdf934(_0x582352, _0x3c6c46)[0x0]),
          _0xfdf934(_0x194fb0)[_0x4132("0x6")] ==
            _0x343372[_0x4132("0x6")] - 0x2 &&
            _0xfdf934(_0x5d90b3)[_0x4132("0x6")] ==
              _0x343372[_0x4132("0x6")] + 0x1 &&
            (function () {
              for (
                var _0x574af6 = 0x0, _0x549de3 = _0x2baee7, _0x138bc0 = 0x0;
                _0x138bc0 < 0x4;
                _0x138bc0++
              )
                _0x2baee7 = (_0x138bc0 + (_0x574af6 += _0x138bc0)) / 0x2;
              return (
                _0x2baee7 && (_0x2baee7 = _0x549de3),
  ...
  return (
    _0x4132("0x11") === document[_0x4132("0x12")] &&
      _0xe3c618("scrollHorizontally"),
